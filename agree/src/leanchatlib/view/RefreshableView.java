...
public class RefreshableView extends LinearLayout implements View.OnTouchListener {
  ...
  public RefreshableView(Context context, AttributeSet attrs) {
    ...
    header = inflate(getContext(), R.layout.chat_pull_to_refresh, null);
  ...
  private void updateHeaderView() {
    ...
    if (status == PULL_TO_REFRESH) {
      tipsView.setText(R.string.chat_pull_to_refresh);
      progressBar.setVisibility(View.GONE);
      arrow.setVisibility(View.VISIBLE);
      rotateArrow();
    } else if (status == RELEASE_TO_REFRESH) {
      tipsView.setText(R.string.chat_release_to_refresh);
      progressBar.setVisibility(View.GONE);
      arrow.setVisibility(View.VISIBLE);
      rotateArrow();
    } else if (status == REFRESHING) {
      tipsView.setText(R.string.chat_refreshing);
