...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 璁剧疆閫氳瘽浜�		nickTextView.setText(username);
		if (!isInComingCall) {// 鎷ㄦ墦鐢佃瘽
		...
		} else { // 鏈夌數璇濊繘鏉�			voiceContronlLayout.setVisibility(View.INVISIBLE);
...
//                                        callStateTextView.setText(st7);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btn_refuse_call: // 鎷掔粷鎺ュ惉
		...
		case R.id.btn_answer_call: // 鎺ュ惉鐢佃瘽
		    answerBtn.setEnabled(false);
		    if (ringtone != null)
                ringtone.stop();
			if (isInComingCall) {
				try {
				    callStateTextView.setText("姝ｅ湪鎺ュ惉...");
		...
		case R.id.btn_hangup_call: // 鎸傛柇鐢佃瘽
