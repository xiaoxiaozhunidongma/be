...
import com.example.takephoto.BaseActivity;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//鏄惁鏄剧ず鏂囨湰缂栬緫妗�		isEditextShow = getIntent().getBooleanExtra("editTextShow",false);
		//杞彂澶嶅埗鐨勫浘鐗囩殑path
		...
		if(path != null){
			 //浼樺厛鎷垮ぇ鍥撅紝娌℃湁鍘诲彇缂╃暐鍥�			if(!new File(path).exists())
